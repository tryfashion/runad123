...
const en = {
  ...
  domainInfo: 'Domain registration',
  domainLogin: 'Sign in to view domain information',
  ...
  note: 'Based on the current page and public Shopify endpoints. Product counts may be limited by what the store exposes. The domain name is sent to runad123 for registration lookup; domain age is not store age.',
  open: 'Open website',
...
const dictionary: Record<UiLocale, typeof en> = {
  ...
  'zh-Hans': {
    ...
    note: '信息来自当前页面和公开 Shopify 接口；商品数受店铺公开接口限制。域名会发送至 runad123 查询注册信息；域名年龄不代表店铺开业时间。',
    open: '打开网站',
    title: '网站概览',
  },
  'zh-Hant': {
    ...
    note: '資訊來自目前頁面和公開 Shopify 介面；商品數受商店公開介面限制。網域會傳送至 runad123 查詢註冊資訊；網域年齡不代表商店開業時間。',
    open: '開啟網站',
    title: '網站概覽',
  },
};
